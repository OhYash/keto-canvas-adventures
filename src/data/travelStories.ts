...
The midnight sun was a phenomenon that took days to truly appreciate. At first, the constant daylight was disorienting, disrupting my sense of time and sleep. But gradually, I learned to embrace the endless golden hour, hiking at 2 AM under light that photographers would kill for.
...
export const getTravelStoryById = (id: string): TravelStory | undefined => {
  return travelStories.find((s) => s.id === id);
};
