...
export const ketoQuote = "In a world full of chaos, Keto reminds me that persistence and having your own safe space (like his beloved terrace) are the keys to contentment.";

export const ketoBadge = "Golden Persian · Terrace King · Professional Pigeon Stalker";
